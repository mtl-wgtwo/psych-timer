...
go_repository(
    ...
    sum = "h1:nLIcFw7GiqKXUS7HiChg6OAYWgASB2H97dZKd1GhDSs=",
    version = "v0.0.0-20180710024300-14dda7b62fcd",
)
...
go_repository(
    ...
    sum = "h1:t2JRgCWkY7Qaa1J2jal+wqC9OjbyHCHwIA9rVlRUSMo=",
    version = "v0.0.0-20180806140643-507816974b79",
)
